...
const makeStyles = (t: Theme) =>
  ...
  backText: {color: '#e7e8ee', fontSize: 14},
  title: {color: '#e7e8ee', fontSize: 18, fontWeight: '700', marginLeft: 12},
  content: {padding: 14, paddingBottom: 40},
  blockTitle: {color: '#e7e8ee', fontSize: 14, fontWeight: '700', marginBottom: 6},
  value: {color: '#c5c7d6', fontSize: 13, marginBottom: 3},
  divider: {height: 1, backgroundColor: t.colors.ghostBg, marginVertical: 12},
  missingBox: {padding: 10, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.05)'},
  missingItem: {color: '#c5c7d6', fontSize: 12, marginBottom: 4},
  primaryBtn: {marginTop: 8, paddingVertical: 12, borderRadius: 14, backgroundColor: '#3a6ef6', alignItems: 'center'},
